...
knitr::include_graphics("img/tabla_frecuencias1.png")
```
...
```{r, echo=FALSE, out.width="100%", fig.align = "center"} 
knitr::include_graphics("img/tabla_frecuencias2.png")
```
<br/>

+ c1 : identificador del intervalo
+ c2 : límite inferior del intervalo
+ c3 : límite superior del intervalo
+ c4 : marca de clase, que corresponde al centro del intervalo 
+ c5 : Frecuencia absoluta, corresponde al número de valores contenidos dentro del intervalo
+ c6 : Frecuencia relativa, corresponde al porcentaje de valores contenidos dentro del intevalo
+ c7 : Frecuencia acumulada absoluta, correponde al número de valores contenidos desde el límite superior del intervalo hacia abajo 
+ c8: Frecuencia relativa acumulada, corresponde al porcentaje de valores ubicados por debajo del límite superior del intervalo 
...
+ 1. id=4 indica que la línea corresponde al cuarto intervalo

+ 2. El intervalo va 3.0 a 3.5 . En este caso como se trata de calificaciones el intervalo se lee (3.0; 3.5]

+ 3. La marca de clase para este intervalo corresponde a 3.25. Este valor se emplea para calculos de indicadores como la media y la varianza a partir de los valores de la tabla

+ 4. $n_4=34$, indica que 34 estudiantes obtivieron notas entre 3.0 y 3.5

+ 5. $h_4= 37.78\%$, nos indica que el treinta y siete punto setenta y ocho porciento de los estudiantos obtuvieron notas entre 3.0 y 3.5

+ 6. $N_4=59$, indica que 59 estudiantes obtuvieron notas iguales o inferiores a 3.5

+ 7. $H_4=65.56\%$, india que el sesenta y cinco punto cincuenta y seis por ciento de los estudiantes obtuvieron una nota igual o inferior a 3.5
...
En el caso de las notas se requiere un tratamiento especial al momento de contruir los intervalos, pues el intervalo 2.5 a 3.00, debe contener los estudiantes que perdieron, por tanto se tienen en cuenta hasta 2.99 y de esta forma no se incluyen los que obtuvieron como nota final 3.0, solo los de 2.5 a 2.99. En estos casos se emplea la función  `cut` 
...
p=ggdistribution(dnorm, seq(-5, 5, 0.01), mean = 0, sd = 1,colour = c11)
p=ggdistribution(dnorm, seq(-5, 5, 0.01), mean = 0, sd = .7,colour = c61, p=p)
p=ggdistribution(dnorm, seq(-5, 5, 0.01),   mean = 0, sd = 1.5,colour = c71, p=p)
p
```
...
# =========================
pal_fill <- c(
  "Asimetría izquierda" = c72,
  "Simétrica"           = c12,
  "Asimetría derecha"   = c62
)

# Líneas (borde): la simétrica la dibujo con azul oscuro para contraste
pal_line <- c(
  "Asimetría izquierda" = c71,
  "Simétrica"           = c11,
  "Asimetría derecha"   = c61
)
