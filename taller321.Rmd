...
#knitr::include_graphics("img/tabla321A.png")
```
\[
...
(a) ¿Cual es la probabilidad que un camión pueda hacer el recorrido completo sin problemas?

(b) ¿Cual es la probabilidad  que un camión tenga un inconveniente en el viaje de ida?

(c) ¿Cual es la probabiliad que un camión encuentre dos inconvenientes en el camino de regreso?

(d) ¿Cual esla probabilidad presente menos de cuatro inconvenientes en todo el recorrido (ida y vuelta)?

(e) En cien viajes con con tres inconvenientes de regreso, ¿cuántos se espera puedan presentar dos inconvenientes en el viaje de ida?
