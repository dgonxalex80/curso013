...
<!-- SVG mantiene visibles las barras de las fracciones al cambiar el zoom. -->
<script type="text/x-mathjax-config">
MathJax.Hub.Config({
  jax: ["input/TeX", "output/SVG"],
  menuSettings: { renderer: "SVG" }
});
</script>
...
El total de de horas, medidas en unidades de 100 horas, que una familia utiliza una lavadora en un periodo de un año es una variable aleatoria continua $X$ que tiene la función de densidad,
