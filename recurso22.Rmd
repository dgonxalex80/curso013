...
Probabilidad condicional: es la probabilidad de que ocurra un evento A, sabiendo que otro evento B ya ha ocurrido, se denota como $P(B|A)$, se define como:
...
```{r, echo=FALSE, out.width="50%", fig.align = "center"}
knitr::include_graphics("img/arbol-6.png")
```

<br/><br/>

En terminos de probabilidad podemos visalizar que la probabilidad condicional se construye a partir de la división de una probabiliad conjunta con una probabilidad marginal 

<br/>

```{r, echo=FALSE, out.width="70%", fig.align = "center"}
knitr::include_graphics("img/tabla-21C.png")
```
