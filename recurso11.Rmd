...
# El archivo ya corresponde al grupo A y no contiene una columna `grupo`.
...
ggplot(conteo_carreras, aes(x = "", y = n, fill = carrera)) +
  ...
  coord_polar(theta = "y") +
  scale_fill_manual(values = c(c21, c31)) +
...
ggplot(grupo013, aes(x = carrera, y = promedio, fill = carrera)) +
