...
* $X$ (accidentes): variable discreta.
* $Y$ (duración del partido): variable continua.
* $M$ (cantidad de leche): variable continua.
* $N$ (número de huevos): variable discreta.
* $P$ (permisos de construcción): variable discreta.
* $Q$ (peso del maíz): variable continua.
* $R$ (edad): variable continua, si se mide el tiempo exacto desde el nacimiento; si se registra en años cumplidos, es discreta.
* $S$ (cantidad de zapatos): variable discreta.
* $T$ (número de crías): variable discreta.
* $U$ (consumo de energía): variable continua.
* $V$ (número de hijos): variable discreta.
* $W$ (número de pasajeros): variable discreta.
* $X$ (gasto diario): variable continua en el modelo habitual de medición monetaria.
* $Y$ (calorías gastadas): variable continua.
* $Z$ (utilidad mensual): variable continua en el modelo habitual de medición monetaria.
