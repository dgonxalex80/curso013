...
```{r crear-edadR, include=FALSE}
clientes$edadR <- cut(
  clientes$edad_cliente,
  breaks = c(-Inf, 20, 30, 40, 50, 60, Inf),
  labels = c(
    "1. (18 a 20 años]", "2. (20 a 30 años]",
    "3. (30 a 40 años]", "4. (40 a 50 años]",
    "5. (50 a 60 años]", "6. (Más de 60 años]"
  )
)
```
